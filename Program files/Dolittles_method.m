...
% Here, we are using LU Factorization using Dolittle's Method which will give 
...
L = eye(n,n);  % initially, L is an identity matrix
U = zeros(n,n);  % initially, U is a zero matrix
for i = 1:n
    for j =1:n
        sum = 0;
        if i>j
